...
const COLUMNS: Column[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Versioned collaboration", desc: "Asynchronous sharing through Takes: Supporters own 10 GB workspaces, invited Core users participate, and local projects always remain editable." },
