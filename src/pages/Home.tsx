...
import { ChevronRight, Check, Music2, Cpu, Layers, Workflow, Headphones, Sparkles, X } from "lucide-react";
...
const FEATURE_LIST = [
  ...
  { icon: Sparkles,   name: "Muse",            desc: "Suggests sounds and helps you finish tracks.", badge: "Coming soon" },
];
