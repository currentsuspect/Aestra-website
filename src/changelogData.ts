...
export const RELEASES: Release[] = [
  {
    ...
    changes: [
      ...
      { type: "new", text: "Audio clip editor panel — open a clip and work on it directly instead of bouncing out to fix one bad bar." },
      ...
      { type: "new", text: "Arsenal sequencer overhaul, plus a redesigned plugin browser with real filters and a scan that doesn't block you." },
